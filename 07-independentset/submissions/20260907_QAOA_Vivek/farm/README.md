...
| Success Threshold | 0 |
| ====== |  |
| Hardware Specifications | QPU: Heron r2 (ibm_fez) ; CPU: VM with 32 cores and 128 GB of RAM. |
| ====== |  |
| Total Runtime | 144.5363 |
| Time to Solution | N/A |
| CPU Runtime | 137.5363 |
| GPU Runtime | N/A |
| QPU Runtime | 7 |
